...
/**
 * Goal which starts mule applications deployment on 'MMC'.
 * 
 * @goal mmc
 * 
 * @phase process-sources
 */
public class MMCDeploymentGoal extends AbstractMojo {

	/**
	 * @parameter expression = "${propertiesFilePath}"
	 */
	private String propertiesFilePath;
	static Logger log = Logger.getLogger(MMCDeploymentGoal.class
			.getName());
	...
	public void execute() throws MojoExecutionException, MojoFailureException {
		...
		try {
			...
			log.info("================================================================================");
			log.info("Deployment process started on 'MMC'");
			log.info("================================================================================");
			...
			// else process the deployment
				...
				// Set target Server as MMC, Deployment will be base on this flag.
				InvokeMMCDeployment.isDeploymentTargetMMC = true;
